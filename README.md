...
#### Author: David Couch
#### This is an app designed to simply display text to your web page from the scripts.js files. 
...
## Setup instructions:  
* Got to ( https://github.com/dcouch440/javascript-pg.git )
...
```bash 
git clone https://github.com/dcouch440/javascript-pg.git
```
